...
_______________
## 6. 라이센스
'OSS_Final_Proj_T2 - 북미'는 비상업적인 용도일 경우 무료로 사용이 가능하고, 수정해 재배포도 가능합니다. 하지만 상업적인 용도로 사용하고자 하는 경우, 아래의 [연락처](#7-연락처)를 통해 연락을 주셔야합니다. 프로젝트에 대한 모든 저작권은 개발자인 임성우, 채시헌, 최중현에게 있습니다.
_______________
## 7. 연락처
임성우
